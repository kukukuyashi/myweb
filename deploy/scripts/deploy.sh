...
echo "==> ensure notes / web dirs"
mkdir -p "$APP_ROOT/笔记" "$APP_ROOT/myweb/Content" "$APP_ROOT/myweb/data"
# 空目录占位，避免 compose 挂载把 Git 未追踪的笔记卷当成错误源
touch "$APP_ROOT/笔记/.gitkeep" 2>/dev/null || true
